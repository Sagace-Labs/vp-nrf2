...
OUTPUTS: list[dict[str, Any]] = [
    {
        ...
        "range": [0.0, 1.0],
        "semantics": (
            "P(activates the antioxidant response element reporter in the Tox21 "
            "qHTS screen). The reporter registers indirect activators alongside direct electrophiles"
        ),
    ...
    },
    {
        ...
        "semantics": (
            ...
            "compound scoring high on both readouts raised the reporter in a cell "
            "that was also dying"
        ),
        "missing": "NaN when RDKit cannot parse the input SMILES",
    },
